...
exports.syncProductsPublicOnWrite = void 0;
const firestore_1 = require("firebase-functions/v2/firestore");
const database_1 = require("../config/database");
const projectProduct_1 = require("./projectProduct");
exports.syncProductsPublicOnWrite = (0, firestore_1.onDocumentWritten)({
    ...
    const srcRef = database_1.db.collection('products').doc(productId);
    const pubRef = database_1.db.collection('productsPublic').doc(productId);
    await database_1.db.runTransaction(async (tx) => {
        const snap = await tx.get(srcRef);
        const pub = (0, projectProduct_1.projectPublicProduct)(snap.exists ? snap.data() : null);
        if (pub) {
            tx.set(pubRef, pub);
        }
        else {
...
//# sourceMappingURL=syncProductsPublic.js.map