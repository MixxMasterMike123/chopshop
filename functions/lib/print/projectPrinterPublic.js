...
exports.projectPrinterPublic = void 0;
...
function projectAreas(src) {
    ...
    for (const [garment, slots] of Object.entries(src)) {
        ...
        for (const [slot, frame] of Object.entries(slots)) {
            if (!isObj(frame) || !num(frame.w) || !num(frame.h))
                continue;
 ...
 */
function projectPrinterPublic(src) {
    if (!src)
        return null;
    return {
...
exports.projectPrinterPublic = projectPrinterPublic;
//# sourceMappingURL=projectPrinterPublic.js.map