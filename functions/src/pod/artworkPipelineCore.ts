...
export type PipelineResult =
  ...
  | { ok: true; printPng: Buffer; previewWebp: Buffer; notices: Notice[]; meta: PipelineMeta };
 ...
 */
export async function runArtworkPipeline(buf: Buffer, profile: PipelineProfile): Promise<PipelineResult> {
